"""
Notification Service — WebSocket-уведомления + история уведомлений
"""
...
from app.core.messaging import consume_rabbitmq
from app.routers import notifications, websocket, health
